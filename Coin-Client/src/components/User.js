    ...
    return (
      <>
        ...
        */}
        ...
        {/* See how the error handling / form handling works */}
        {/* Also set it so the facebook github etc. logos don't work. if you can integrate google auth that would be cool since for sure will do in future. */}
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500">Or continue with (These dont work)</span>
                  </div>
                </div>
